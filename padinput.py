...
def getPadInput(pad: pygame.joystick.Joystick, pad_number):
    ...
    just_pressed_input_strings = input_strings
...
def drawPads(screen, rawinputs):
    screen.blit(pygame.transform.flip(drawPadInput(rawinputs[0]),1,1), pygame.Rect(50,50,90,90))
    screen.blit(drawPadInput(rawinputs[1]), pygame.Rect(50+90+20,50,90,90))